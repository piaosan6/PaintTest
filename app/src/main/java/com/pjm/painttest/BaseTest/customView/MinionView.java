...
//      左边的小口袋
        ...
        canvas.drawArc(new RectF(mBodyRect.left - radiusSamllPokect, mBodyRect.bottom - mRadius - radiusSamllPokect,
                mBodyRect.left + radiusSamllPokect, mBodyRect.bottom - mRadius + radiusSamllPokect), 80, -60, false, mPaint);
//      右边小口袋
        canvas.drawArc(new RectF(mBodyRect.right - radiusSamllPokect, mBodyRect.bottom - mRadius - radiusSamllPokect,
...
//      右脚
    ...
    private void drawFeetShadow(Canvas canvas) {
        ...
        canvas.drawOval(new RectF(mBodyRect.left + mBodyWidth * 0.15f, mBodyRect.bottom - mOffset + mFootHeight,
