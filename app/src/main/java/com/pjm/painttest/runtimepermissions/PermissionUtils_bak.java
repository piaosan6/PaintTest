...
public class PermissionUtils_bak {

    private static final String TAG = PermissionUtils_bak.class.getSimpleName();
     ...
     */
    public static void requestPermission(final Activity activity, final int requestCode, PermissionCallBack permissionCallBack) {
        if (activity == null) {
            return;
        }
        ...
        if (checkSelfPermission != PackageManager.PERMISSION_GRANTED) {
           ...
           /*if (ActivityCompat.shouldShowRequestPermissionRationale(activity, requestPermission)) {
            ...
            permissionCallBack.applyPermissionSuccess(requestCode);
        }
    }
    ...
    private static void requestMultiResult(Activity activity, String[] permissions, int[] grantResults, PermissionCallBack permissionCallBack) {
        ...
        if (notGranted.size() == 0) {
            ...
            permissionCallBack.applyPermissionSuccess(CODE_MULTI_PERMISSION);
        } else {
     ...
     * 一次申请多个权限
     */
    public static void requestMultiPermissions(final Activity activity, PermissionCallBack grant) {
        ...
        if (permissionsList.size() > 0) {
            ...
            grant.applyPermissionSuccess(CODE_MULTI_PERMISSION);
        }
    }
    ...
    public static void requestPermissionsResult(final Activity activity, final int requestCode,
        ...
        if (grantResults.length == 1 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            //TODO
            String[] permissionsHint = activity.getResources().getStringArray(R.array.permissions);
            openSettingActivity(activity, "拒绝授权后弹框：" + permissionsHint[requestCode]);
        }
    }
