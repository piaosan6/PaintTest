        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (mPosition != INVALID_POSITION) {
                    ...
                    // 获取触碰点所在的view
                    ViewGroup rootView = (ViewGroup) getChildAt(mPosition - ((LinearLayoutManager) getLayoutManager()).findFirstVisibleItemPosition());
                    if(rootView.getChildCount() > 1){
                        mFlingView = rootView;
                    }else{
                        mFlingView = (ViewGroup) rootView.getChildAt(0);
                    }
