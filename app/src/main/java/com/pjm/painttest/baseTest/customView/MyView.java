package com.pjm.painttest.baseTest.customView;
...
//        drawComposePathEffectDemo(canvas);
    ...
    public void drawStrokeCap(Canvas canvas){
    ...
    public void drawStrokeJoin(Canvas canvas){
        Paint paint = new Paint();
    ...
    public void drawCornerPathEffect(Canvas canvas){
     ...
     * @param canvas
     */
    public void drawCornerPathEffectDemo(Canvas canvas){
        Paint paint = getPaint();
        Path path = getPath();
        canvas.drawPath(path,paint);
    ...
    public void drawDashPathEffectDemo(Canvas canvas){
        Paint paint = getPaint();
        Path path = getPath();
    ...
    public void drawDiscretePathEffectDemo(Canvas canvas){
        Paint paint = getPaint();
        Path path = getPath();
    ...
    public void drawPathDashPathEffectDemo(Canvas canvas){
        Paint paint = getPaint();
    ...
    public void drawPathDashPathEffect(Canvas canvas){
        Paint paint = getPaint();
    ...
    public void drawComposePathEffectDemo(Canvas canvas){
        //画原始路径
        Paint paint = getPaint();
        Path path = getPath();
        canvas.drawPath(path,paint);
    ...
    public void drawSubpixelText(Canvas canvas){
